            ...
            <div id="main" style="padding-top: 10px;">
                <form id="studentform" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"name="department" id="department" placeholder="请输入专业">
                    </div>
                    <div class="form-group">
                        <label for="dormitoryselect">宿舍</label>
                        <select id="dormitoryselect" name="dormitory.did"></select>
                    </div>
                    <button class="btn btn-default" id="deletestudentbt">删除</button>
                    <button class="btn btn-default" id="modifystudentbt">提交</button>
                </form>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="../static/js/studentoperation.js"></script>
</body>
